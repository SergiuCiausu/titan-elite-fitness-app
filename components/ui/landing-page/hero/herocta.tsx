    ...
    return (
        <div
            className="flex flex-col items-center justify-center gap-8 w-full">
                <p className="text-secondary-foreground text-center text-base 3xl:text-xl">Antrenori dedicați, echipamente premium Panatta & LifeFitness și programe personalizate pentru orice nivel.</p>
                <div
